...
export function trackSignUp(
  ...
  // Where the signup started: the /signup page or the sign-in page. Registered
  // as a GA4 custom dimension, so it is reportable.
  gaEvent("sign_up", { method, signup_source: intent?.source });
